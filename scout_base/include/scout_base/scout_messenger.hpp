...
public:
    ...
    void SendCommandToRobot(double linear, double angular);
...
private:
    ...
    ros::Subscriber rangezed_subscriber_;
    ...
    void RangeZedCallback(const std_msgs::Float32::ConstPtr &msg);
